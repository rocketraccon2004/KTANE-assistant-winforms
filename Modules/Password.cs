...
public class Password : Module
{
    private static readonly string[] Words =
        ("about,after,again,below,could,every,first,found,great,house,large,learn,never,other,place,plant,point,right,small,sound," +
    ...
    public Password(List<string>? column1, List<string>? column2, List<string>? column3, List<string>? column4,
        List<string>? column5)
    {
        _column1 = column1;
        _column2 = column2;
    ...
    private string SolveWord()
    {
        ...
        var possibleWords =
            (from letter in combinationLetters from word in Words where word.StartsWith(letter) select word).ToList();
