namespace KTANE_Assistant.Forms
{
	partial class frmBlindAlley
	{
		...
		private void InitializeComponent()
		{
			...
			tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 33.3333321F));
			tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 33.3333321F));
			tableLayoutPanel1.Size = new Size(650, 302);
			tableLayoutPanel1.TabIndex = 82;
			// 
			// button8
			// 
			button8.Location = new Point(435, 203);
			button8.Name = "button8";
			button8.Size = new Size(210, 94);
			button8.TabIndex = 8;
			button8.UseVisualStyleBackColor = true;
			// 
			// button7
			// 
			button7.Location = new Point(219, 203);
			button7.Name = "button7";
			button7.Size = new Size(210, 94);
			button7.TabIndex = 7;
			...
			button6.Size = new Size(210, 94);
			button6.TabIndex = 6;
			button6.UseVisualStyleBackColor = true;
			// 
			// button5
			// 
			button5.Location = new Point(435, 103);
			button5.Name = "button5";
			button5.Size = new Size(210, 94);
			button5.TabIndex = 5;
			button5.UseVisualStyleBackColor = true;
			// 
			// button4
			// 
			button4.Location = new Point(219, 103);
			button4.Name = "button4";
			button4.Size = new Size(210, 94);
			button4.TabIndex = 4;
